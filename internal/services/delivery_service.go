...
func (s *deliveryService) GetDeliveriesByOrderID(ctx context.Context, orderID int64) ([]*models.DeliveryResponse, error) {
	return s.repo.GetDeliveriesByOrderID(ctx, orderID)
}
